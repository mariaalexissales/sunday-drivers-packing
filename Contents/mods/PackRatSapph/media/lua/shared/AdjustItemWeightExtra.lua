...
AdjustWeight("PR.10pkBasil", "Base.Basil", 10, 0.5)
AdjustWeight("PR.50pkBasil", "Base.Basil", 50, 0.5)
AdjustWeight("PR.10pkChives", "Base.Chives", 10, 0.5)
AdjustWeight("PR.50pkChives", "Base.Chives", 50, 0.5)
AdjustWeight("PR.10pkCilantro", "Base.Cilantro", 10, 0.5)
AdjustWeight("PR.50pkCilantro", "Base.Cilantro", 50, 0.5)
AdjustWeight("PR.10pkOregano", "Base.Oregano", 10, 0.5)
AdjustWeight("PR.50pkOregano", "Base.Oregano", 50, 0.5)
AdjustWeight("PR.10pkSage", "Base.Sage", 10, 0.5)
AdjustWeight("PR.50pkSage", "Base.Sage", 50, 0.5)
AdjustWeight("PR.10pkThyme", "Base.Thyme", 10, 0.5)
AdjustWeight("PR.50pkThyme", "Base.Thyme", 50, 0.5)
AdjustWeight("PR.10pkBlackSage", "Base.BlackSage", 10, 0.5)
AdjustWeight("PR.50pkBlackSage", "Base.BlackSage", 50, 0.5)
AdjustWeight("PR.10pkComfrey", "Base.Comfrey", 10, 0.5)
AdjustWeight("PR.50pkComfrey", "Base.Comfrey", 50, 0.5)
AdjustWeight("PR.10pkPlantain", "Base.Plantain", 10, 0.5)
AdjustWeight("PR.50pkPlantain", "Base.Plantain", 50, 0.5)
AdjustWeight("PR.10pkLemonGrass", "Base.LemonGrass", 10, 0.5)
AdjustWeight("PR.50pkLemonGrass", "Base.LemonGrass", 50, 0.5)
AdjustWeight("PR.10pkNettles", "Base.Nettles", 10, 0.5)
AdjustWeight("PR.50pkNettles", "Base.Nettles", 50, 0.5)
AdjustWeight("PR.10pkWildGarlic", "Base.WildGarlic", 10, 0.5)
AdjustWeight("PR.50pkWildGarlic", "Base.WildGarlic", 50, 0.5)
AdjustWeight("PR.10pkCommonMallow", "Base.CommonMallow", 10, 0.5)
AdjustWeight("PR.50pkCommonMallow", "Base.CommonMallow", 50, 0.5)
AdjustWeight("PR.10pkThistles", "Base.Thistles", 10, 0.5)
AdjustWeight("PR.50pkThistles", "Base.Thistles", 50, 0.5)
AdjustWeight("PR.10pkViolets", "Base.Violets", 10, 0.5)
AdjustWeight("PR.50pkViolets", "Base.Violets", 50, 0.5)
...
AdjustWeight("PR.4pkPaintBlack", "Base.PaintBlack", 4, 0.5)
AdjustWeight("PR.4pkPaintBlue", "Base.PaintBlue", 4, 0.5)
AdjustWeight("PR.4pkPaintBrown", "Base.PaintBrown", 4, 0.5)
AdjustWeight("PR.4pkPaintCyan", "Base.PaintCyan", 4, 0.5)
AdjustWeight("PR.4pkPaintGreen", "Base.PaintGreen", 4, 0.5)
AdjustWeight("PR.4pkPaintGrey", "Base.PaintGrey", 4, 0.5)
AdjustWeight("PR.4pkPaintLightBlue", "Base.PaintLightBlue", 4, 0.5)
AdjustWeight("PR.4pkPaintLightBrown", "Base.PaintLightBrown", 4, 0.5)
AdjustWeight("PR.4pkPaintOrange", "Base.PaintOrange", 4, 0.5)
AdjustWeight("PR.4pkPaintPink", "Base.PaintPink", 4, 0.5)
AdjustWeight("PR.4pkPaintPurple", "Base.PaintPurple", 4, 0.5)
AdjustWeight("PR.4pkPaintRed", "Base.PaintRed", 4, 0.5)
AdjustWeight("PR.4pkPaintTurquoise", "Base.PaintTurquoise", 4, 0.5)
AdjustWeight("PR.4pkPaintWhite", "Base.PaintWhite", 4, 0.5)
AdjustWeight("PR.4pkPaintYellow", "Base.PaintYellow", 4, 0.5)
